...
<div class="container-fluid">
    ...
    <div class="card card-outline card-primary">
        <div class="card-header">
            <h3 class="card-title"><i class="fas fa-user-check"></i> Mark & View Attendance</h3>
        </div>
        <div class="card-body">
            <form method="get" action="<?= htmlspecialchars($_SERVER['PHP_SELF']) ?>">
                <div class="row align-items-end">
                    ...
                    <div class="col-md-5"><label for="date">Select Date</label><input type="date" name="date" id="date"
                            class="form-control" value="<?= htmlspecialchars($selected_date) ?>" required></div>
    ...
    <div class="card mt-4">
        <div class="card-header">
            <h3 class="card-title"><i class="fas fa-qrcode"></i> QR Code Scanner</h3>
        </div>
        <div class="card-body text-center">
            <div id="scanner-wrapper"
                style="max-width: 400px; margin: auto; border: 1px solid #ddd; padding: 10px; border-radius: 5px;">
    ...
    <div class="card mt-4">
        <div class="card-header">
            <h3 class="card-title">Manual Attendance Sheet for <?= htmlspecialchars($selected_date) ?></h3>
        </div>
        <div class="card-body">
            <form method="post" action="process_attendance.php">
                ...
                <div class="text-end mt-3"><button type="submit" name="mark_attendance" class="btn btn-success">Save
                        Manual Attendance</button></div>
            </form>
        </div>
    </div>
    <?php endif; ?>
    ...
    if (classSelector.value) {
        ...
        html5QrCode.start({
            ...
            .catch(err => {
                ...
                document.getElementById('scanner-wrapper').innerHTML =
                    '<div class="alert alert-danger">Could not start camera. Please grant permission and refresh the page.</div>';
            });
    }

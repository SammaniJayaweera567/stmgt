<?php
ob_start();
// Assuming index.php is in the 'web' folder, this path is correct
include '../init.php';

// Fetch active class levels from the database
$db = dbConn();
$sql = "SELECT * FROM class_levels WHERE status = 'Active' ORDER BY id ASC";
$result_levels = $db->query($sql);
?>

<!-- === NEW CSS RULE TO FIX THE GAP === -->
<style>
/* This rule specifically targets the grade cards in the 'site-section' */
.site-section .feature-1-content {
    /* This ensures the card itself doesn't have extra bottom margin that collapses */
    padding-bottom: 1.5rem;
}

.site-section .row>.col-lg-3,
.site-section .row>.col-md-6 {
    /* This adds a reliable bottom margin to each card's column */
    margin-bottom: 100px;
}
</style>

<!-- Your existing top HTML part remains the same -->
<div class="hero-slide owl-carousel site-blocks-cover">
    <div class="intro-section" style="background-image: url('images/tusion-bg2.jpg');">
        <div class="container">
    ...
    <div class="intro-section" style="background-image: url('images/tusion-bg1.jpg');">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12 mx-auto text-center" data-aos="fade-up">
...
<div class="site-section">
    <div class="container">
        ...
        <!-- The main row for all grade cards -->
        <div class="row">
            <?php
            // Loop through the class levels fetched from the database
            ...
            <div class="col-lg-3 col-md-6">
                <div class="feature-1 border">
                    ...
                    <div class="feature-1-content">
                        ...
                        <p>Find classes and subjects available for this grade.</p>
                        <!-- Dynamic Link to subjects.php -->
                        <p><a href="<?= WEB_URL ?>subjects.php?level_id=<?= $level['id'] ?>"
                                class="btn btn-primary px-4 rounded-0">Click Here</a></p>
                    </div>
                </div>
            </div>
            <?php
                ...
                // Message if no active grades are found
                echo '<div class="col-12 text-center"><p>Grade levels are not available at the moment. Please check back later.</p></div>';
            }
            ?>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus assumenda omnis tempora
                    ullam
                    alias amet eveniet voluptas, incidunt quasi aut officiis porro ad, expedita saepe necessitatibus
                    rem
                    debitis architecto dolore? Nam omnis sapiente placeat blanditiis voluptas dignissimos, itaque
                    fugit
                    a laudantium adipisci dolorem enim ipsum cum molestias? Quod quae molestias modi fugiat
                    quisquam.
...
<?php
$content = ob_get_clean();             //uda content eka me variable ekata awith layout file ekata insert wenawa.
include 'layouts.php';
?>